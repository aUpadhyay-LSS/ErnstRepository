$(document).ready(function(){
    ...
    var row328=($('input[name="row[157]"]').asNumber()||0)+($('input[name="row[159]"]').asNumber()||0)+($('input[name="row[163]"]').asNumber()||0)+
      ...
      ($('input[name="row[293]"]').asNumber()||0)+($('input[name="row[296]"]').asNumber()||0)+($('input[name="row[301]"]').asNumber()||0)+
      ($('input[name="row[306]"]').asNumber()||0)+($('input[name="row[309]"]').asNumber()||0)+($('input[name="row[312]"]').asNumber()||0)+
    ...
    ($('input[name="row[294]"]').asNumber()||0)+($('input[name="row[297]"]').asNumber()||0)+($('input[name="row[302]"]').asNumber()||0)+
    ($('input[name="row[307]"]').asNumber()||0)+($('input[name="row[310]"]').asNumber()||0)+($('input[name="row[313]"]').asNumber()||0)+
